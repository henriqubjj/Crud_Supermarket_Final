...
#usuario_id = crud.adicionar_usuario(nome="João Silva", email="aleatorio@gmail.com", senha="1234", telefone="123456789", endereco="Rua das Flores 123", is_flamengo=1, watch_one_piece=1, is_de_sousa=0, is_funcionario=0)
